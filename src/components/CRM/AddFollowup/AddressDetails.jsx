      ...
      <div className="form-row" style={{ display: 'flex', gap: '1rem' }}>
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input
            ...
            onChange={(e) => setFollowupData({ ...followupData, address: e.target.value })}
            id="address"
            ref={addressRef}
        ...
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input
            ...
            onChange={(e) => setFollowupData({ ...followupData, unit_no: e.target.value })}
            id="unitNo"
            placeholder="Unit No"
          />
        </div>
        ...
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input
            ...
            onChange={(e) => setFollowupData({ ...followupData, city: e.target.value })}
            id="city"
            placeholder="City"
          />
        </div>
      ...
      <div className="form-row" style={{ display: 'flex', gap: '1rem' }}>
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input
            ...
            onChange={(e) => setFollowupData({ ...followupData, state: e.target.value })}
            id="state"
            placeholder="State"
          />
        </div>
        ...
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input
            ...
            onChange={(e) => setFollowupData({ ...followupData, country: e.target.value })}
            id="country"
            placeholder="Country"
          />
        </div>
        <div className="form-group" style={{ flex: 1 }}>
          ...
          <input
            ...
            onChange={(e) => setFollowupData({ ...followupData, postal_code: e.target.value })}
            id="postalCode"
